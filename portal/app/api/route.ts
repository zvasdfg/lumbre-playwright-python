...
export async function GET() {
  ...
  const testAndDevelopmentEndpoints = [
    ...
    "GET /api/account/blends",
    "POST /api/account/blends",
    "POST /api/account/blends/{id}/submit",
    "DELETE /api/account/blends/{id}",
    ...
    "GET /api/admin/blends",
    "PATCH /api/admin/blends/{id}",
    "GET /api/orders",
    "POST /api/orders",
    "GET /api/orders/{id}",
    ...
    "GET /api/fire-presets",
    "POST /api/fire-presets",
    "POST /api/fire-presets/sync",
    "DELETE /api/fire-presets/{id}",
    "POST /api/hipotesis",
    "POST /api/members",
