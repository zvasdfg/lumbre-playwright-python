...
from automation.core.reporting.test_logger import TestLogger
...
def pytest_html_report_title(report: Any) -> None:
    report.title = f"{settings.project_name} · Playwright Test Report"
...
def pytest_html_results_summary(
    ...
    prefix.append(
        '<div class="automation-report-intro">'
        f"<strong>{html.escape(settings.project_name)} QA Lab</strong> · Pytest + Playwright · "
